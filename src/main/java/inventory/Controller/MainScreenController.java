...
public class MainScreenController implements Initializable {
    ...
    public void addPartsButton(ActionEvent actionEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/inventory/View/AddPart.fxml"));
    ...
    public void addProductsButton(ActionEvent actionEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/inventory/View/AddProduct.fxml"));
        Stage stage = (Stage)((Node)actionEvent.getSource()).getScene().getWindow();
        Scene scene = new Scene(root);
    ...
    public void modifyPartsButton(ActionEvent actionEvent) throws IOException {
        ...
        loader.setLocation(getClass().getResource("/inventory/View/ModifyPart.fxml"));
        loader.load();
    ...
    public void modifyProductsButton(ActionEvent actionEvent) throws IOException {
        ...
        if (selectModifyProduct == null) {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/inventory/View/ModifyProduct.fxml"));
            loader.load();
