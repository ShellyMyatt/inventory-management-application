 ...
 * The JavaDOC's is saved in the main folder, in the java folder, in the inventory folder.
 * @author Shelly Myatt
 */
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/inventory/View/MainScreen-view.fxml"));
